      ...
      <div className="max-w-screen-lg p-4 flex flex-col mx-auto justify-center w-full h-full">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0 ">
          ...
          <div key={id} className="shadow-md shadow-gray-500 rounded-lg ">
            <Image className='rounded-lg duration-300 hover:scale-105' src={src} alt="chatgpt" />
            <div className="flex items-center justify-center">
              <button className='py-3 w-1/2 px-6 m-4 duration-200 hover:scale-100'>Demo</button>
              <button className='py-3 w-1/2 px-6 m-4 duration-200 hover:scale-100'>Code</button>
            </div>
          </div>
